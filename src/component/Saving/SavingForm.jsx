...
const ExpensesForm = () => {
  const { addSavings, getSavings, error } = useGlobalContext();
      ...
      <div className=" w-[100%] flex flex-col lg:flex-row lg:items-center gap-[10px] lg:justify-between ">
        ...
        <div className=" ">
          ...
          >
            ...
            <option value="Salary">Phone</option>
            <option value="Bonus">House</option>
            <option value="Freelancer">Fashion</option>
            <option value="Investment">Investment</option>
            <option value="Transfer">Family</option>
